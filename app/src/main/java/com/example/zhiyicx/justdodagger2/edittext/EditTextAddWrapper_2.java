...
// */
//
//public class EditTextAddWrapper_2<T extends EditText> implements TextWatcher {
...
//     * @param params
//     */
//    public EditTextAddWrapper_2(T editText, CharSequence add, Integer[] params) {
...
//     * @param perLen
//     */
//    public EditTextAddWrapper_2(T editText, CharSequence add, int start, int perLen) {
//        this.editText = editText;
//        this.add = add;
//        this.start = start;
//        this.perLen = perLen;
...
//    }
//
//    public void formatEditable(Editable s) {
//        StringBuilder sBuilder = new StringBuilder(s.toString());
//        if (type == 0) {
//            for (int i = 0; i < params.length && s.length() > params[i]; i++) {
//                if (sBuilder.subSequence(params[i] +
//                        index * add.length(), params[i] + (index + 1) * add.length()).equals(add)) {
//                    if (sBuilder.length() == (params[i] + (index + 1) * add.length())) {
//                        sBuilder.delete(params[i] +
//                                index * add.length(), params[i] + (index + 1) * add.length());
//                    }
//                } else {
//                    sBuilder.insert(params[i] + index * add.length(), add);
//                }
//            }
//        } else {
//            for (int i = 0; start + perLen * i + index)
//        }
//        s.replace(0, s.length(), sBuilder);
//    }
//}
